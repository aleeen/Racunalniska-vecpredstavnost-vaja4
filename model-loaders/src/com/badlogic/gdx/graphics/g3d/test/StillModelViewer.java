...
public class StillModelViewer implements ApplicationListener {
	...
	public static void main(String[] argv) {
		...
		new JoglApplication(new StillModelViewer("data/trashbin.obj"), "StillModel Viewer", 800, 480, false);
		//new JoglApplication(new StillModelViewer("data/mini_obj.obj"), "StillModel Viewer", 800, 480, false);
		//new JoglApplication(new StillModelViewer("data/hammer.obj"), "StillModel Viewer", 800, 480, false);
	}
}
